...
void PropertyMain::addProperty(QString thisAddress, QString numTenants){
     ...
     button->setText("Remove Property");
     button->setObjectName("removePropertyButton");
